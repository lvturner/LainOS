...
if [ "$CURRENT_USER" != "lainos" ]; then
    ...
    echo -e "    ${CYAN}sudo cp -r $SCRIPT_DIR /home/lainos/lainos${RESET}"
    echo -e "    ${CYAN}sudo chown -R lainos:lainos /home/lainos/lainos${RESET}"
    echo -e "    ${CYAN}sudo su - lainos${RESET}"
    echo -e "    ${CYAN}cd ~/lainos && ./start.sh${RESET}"
    echo ""
